...
Crucialmente, incrementar a quantidade de instâncias no cluster não consiste de uma escolha uniformemente ótima; a priori, com efeito, poderíamos acreditar que, para uma quantidade arbitrariamente grande de nós de computação, poderíamos gozar de um tempo de processamento arbitrariamente enxuto. 
